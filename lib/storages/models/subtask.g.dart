...
Subtask _subtaskDeserialize(
  ...
  final object = Subtask(
    isChecked: reader.readBoolOrNull(offsets[0]),
...
extension SubtaskQueryFilter
  ...
  QueryBuilder<Subtask, Subtask, QAfterFilterCondition> isCheckedIsNull() {
  ...
  QueryBuilder<Subtask, Subtask, QAfterFilterCondition> isCheckedIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Subtask, Subtask, QAfterFilterCondition> textIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'text',
      ));
  ...
  QueryBuilder<Subtask, Subtask, QAfterFilterCondition> textIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'text',
      ));
